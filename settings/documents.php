...
if (isset($_POST['application'])) {
    ...
    $memDir = dirname(dirname(__FILE__)). '/applications/'.$memberName;
...
if (isset($_POST['mandate'])) {
    ...
    $mandateName = $user['uid'] .'_'. $user['first_name'] .'_'. $user['last_name'] .'_'. $user['verify_code']  .'.pdf';

    $sepaDir = dirname(dirname(__FILE__)). '/mandates/'.$mandateName;
